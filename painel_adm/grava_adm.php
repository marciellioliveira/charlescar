<?php
  ...
  $conecta->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
   ...
   $consulta = $conecta->query("SELECT * FROM adm WHERE email='$em'");
   ...
   if ($linha>0)
   {
      ...
      $_SESSION['valida']='1';
      header('location:painel_adm/consultapdo.php');
   ...
   else
   {
      ...
      $textoSQL="INSERT INTO adm(nome, sobrenome, email, senha) VALUES ('".$primnome."','".$segnome."','".$em."','".$se."')";  
